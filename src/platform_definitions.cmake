...
if((${CMAKE_COMPILER_IS_GNUCXX}) OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang"))
    ...
    #For Release
    set(CMAKE_C_FLAGS_RELEASE "-g -O2 -pthread ${COMMON_FLAGS_WARNINGS}")
    set(CMAKE_CXX_FLAGS_RELEASE "-g -O2 ${COMMON_FLAGS_CXX_CONF}")
    #For MaxOptz
    set(CMAKE_C_FLAGS_MAXOPTZ "-g -O3 -pthread ${COMMON_FLAGS_WARNINGS}")
    set(CMAKE_CXX_FLAGS_MAXOPTZ "-g -O3 ${COMMON_FLAGS_CXX_CONF}")
endif()
