...
TEST_EXCEPTION(ex_MANAGE_DIRECT_DEBIT_MALFORMED)
TEST_EXCEPTION(ex_MANAGE_DIRECT_DEBIT_SELF_NOT_ALLOWED)
TEST_EXCEPTION(ex_MANAGE_DIRECT_DEBIT_NO_TRUST)
TEST_EXCEPTION(ex_MANAGE_DIRECT_DEBIT_EXIST)
TEST_EXCEPTION(ex_MANAGE_DIRECT_DEBIT_NOT_EXIST)
TEST_EXCEPTION(ex_MANAGE_DIRECT_DEBIT_LOW_RESERVE)
TEST_EXCEPTION(ex_MANAGE_DIRECT_DEBIT_DEBITOR_NOT_EXIST)

TEST_EXCEPTION(ex_DIRECT_DEBIT_PAYMENT_MALFORMED)
TEST_EXCEPTION(ex_DIRECT_DEBIT_PAYMENT_NOT_ALLOWED)
TEST_EXCEPTION(ex_DIRECT_DEBIT_PAYMENT_ACCOUNT_NOT_EXIST)
