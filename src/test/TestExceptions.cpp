...
throwIf(ManageDirectDebitResult const& result)
{
	...
	case MANAGE_DIRECT_DEBIT_LOW_RESERVE:
		throw ex_MANAGE_DIRECT_DEBIT_LOW_RESERVE{};
	case MANAGE_DIRECT_DEBIT_DEBITOR_NOT_EXIST:
		throw ex_MANAGE_DIRECT_DEBIT_DEBITOR_NOT_EXIST{};
...
throwIf(DirectDebitPaymentResult const& result) {
	...
	case DIRECT_DEBIT_PAYMENT_NOT_ALLOWED:
		throw ex_DIRECT_DEBIT_PAYMENT_NOT_ALLOWED{};
	case DIRECT_DEBIT_PAYMENT_ACCOUNT_NOT_EXIST:
		throw ex_DIRECT_DEBIT_PAYMENT_ACCOUNT_NOT_EXIST{};
